...
import br.com.dev.cliente.dto.ValidationError;
...
public class CotrollerExceptionHandler {
    ...
    public ResponseEntity<CustomError> methodArgumentNotValid(MethodArgumentNotValidException e, HttpServletRequest request){
        ...
        ValidationError err = new ValidationError(Instant.now(), status.value(), "Dado obrigatorio faltando", request.getRequestURI());
